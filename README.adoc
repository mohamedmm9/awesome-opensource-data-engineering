...
* https://www.mongodb.com/[MongoDB] - an open-source database that uses a document-oriented data model.
* https://memgraph.com/memgraphdb/[Memgraph] - fast graph database for streaming data.
